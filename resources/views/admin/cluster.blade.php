            ...
            <div class="col-md-3 mb-4">
                <div class="card h-100">
                    ...
                    groupData.members.forEach(member => {
                        ...
                        const gpa = member.gpa !== 'N/A' ? parseFloat(member.gpa).toFixed(2) : 'N/A';
                        const lastGpa = member.last_gpa !== 'N/A' ? parseFloat(member.last_gpa).toFixed(2) :
                            'N/A';
                        const finalScore = member.final_score !== 'N/A' ? parseFloat(member.final_score)
                            .toFixed(2) : 'N/A';
